    ...
    return (
        <form className="bg-white my-8 p-8 rounded-md" onSubmit={handlePost}>
            ...
            <div className="flex items-center justify-between gap-2">
                ...
                <button className="text-sm bg-blue-700 rounded-md disabled:opacity-25 text-white transition-all hover:bg-blue-500 px-6 py-2 active:bg-blue-800" type="submit" disabled={isDisabled}>Create a post</button>
            </div>
        </form>
    )
}
